...
<link rel="stylesheet" href="{{ asset('assets/plugins/uikit/css/uikit.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/plugins/animate/animate.css') }}">
<link rel="stylesheet" href="{{ asset('assets/plugins/bttn/bttn.min.css') }}">
<link class="main-stylesheet" href="{{ asset('main/css/themes/modern.css') }}" rel="stylesheet" type="text/css" />
