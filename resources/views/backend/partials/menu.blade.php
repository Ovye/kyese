    ...
    <nav class="page-sidebar" data-pages="sidebar">
        ...
        <div class="sidebar-header">
            <img src="{{ asset('assets/img/ky-logo-white.png') }}" alt="logo" data-src="{{ asset('assets/img/ky-logo-white.png') }}" data-src-retina="{{ asset('assets/img/ky-logo-white-lg.png') }}" style="width: 78px">
        ...
        <div class="sidebar-menu">
            ...
            <ul class="menu-items">
                <li class="m-t-30 @activeFor('dashboard')">
                    <a href="{{ url('dashboard') }}" class="detailed">
                        <span class="title">Dashboard</span>
                        <span class="details">Online as: {{ auth()->user()->username }}</span>
                    </a>
                    <span class="bg-success icon-thumbnail"><i class="pg-home"></i></span>
                </li>
                @role('admin')
                <li class="@activeFor('admin/users')">
                    <a href="javascript:;"><span class="title">Users Manager</span>
                        <span class="arrow @activeFor('admin/users')"></span></a>
                    <span class="icon-thumbnail"><i class="sl sl-icon-people"></i></span>
                    <ul class="sub-menu">
                        <li class="">
                            <a href="{{ url('admin/users/permissions') }}">Permissions</a>
                            <span class="icon-thumbnail">UP</span>
                        </li>
                        <li class="">
                            <a href="{{ url('admin/users/roles') }}">Roles</a>
                ...
                <li class="">
                    <a href="../../../../../changelog.pages.revox.io/index.html" target="_blank"><span class="title">Changelog</span></a>
