...
@endif
<script src="{{ asset('assets/js/tinymce/tinymce.min4bb5.js?apiKey=4cuu2crphif3fuls3yb1pe4qrun9pkq99vltezv2lv6sogci') }}"></script>
...
<script src="{{ asset('assets/js/chartist.min.html') }}"></script>
